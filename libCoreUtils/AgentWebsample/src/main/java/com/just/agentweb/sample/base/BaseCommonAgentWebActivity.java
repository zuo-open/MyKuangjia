...
public abstract class BaseCommonAgentWebActivity extends AppCompatActivity implements View.OnClickListener, FragmentKeyDown, FileCompressor.FileCompressEngine {
    ...
    protected void initView() {
        ...
        ivMore = findViewById(R.id.iv_web_more);
    ...
    protected void buildAgentWeb() {
        ...
        AgentWeb.IndicatorBuilder indicatorBuilder = AgentWeb.with(this)
                .setAgentWebParent(getAgentWebParent(), -1, new ViewGroup.LayoutParams(-1, -1));
        ...
        return new AbsAgentWebSettings() {
            ...
            public WebListenerManager setDownloader(WebView webView, android.webkit.DownloadListener downloadListener) {
                return super.setDownloader(webView,
                        new DefaultDownloadImpl(BaseCommonAgentWebActivity.this,
                                webView,
                                this.mAgentWeb.getPermissionInterceptor()) {

                            @Override
                            protected ResourceRequest createResourceRequest(String url) {
                                return DownloadImpl.getInstance(BaseCommonAgentWebActivity.this)
                                        .url(url)
                                        .quickProgress()
                                        .addHeader("", "")
...
//			Log.i(TAG, "onReceivedError:" + errorCode + "  description:" + description + "  errorResponse:" + failingUrl);
    ...
    public void compressFile(String type, final Uri[] uri, ValueCallback<Uri[]> callback) {
        ...
        if (uri == null || uri.length == 0) {
            ...
            final String[] paths = AgentWebUtils.uriToPath(BaseCommonAgentWebActivity.this, uri);
    ...
    private PopupMenu.OnMenuItemClickListener mOnMenuItemClickListener = new PopupMenu.OnMenuItemClickListener() {
        ...
        public boolean onMenuItemClick(MenuItem item) {
            ...
            if (itemId == R.id.refresh) {
                ...
                if (mAgentWeb != null) {
                    toCopy(BaseCommonAgentWebActivity.this, mAgentWeb.getWebCreator().getWebView().getUrl());
                }
                return true;

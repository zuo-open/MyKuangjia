...
import static com.just.agentweb.sample.activity.AgentWebMainActivity.FLAG_GUIDE_DICTIONARY_BOUNCE_EFFACT;
import static com.just.agentweb.sample.activity.AgentWebMainActivity.FLAG_GUIDE_DICTIONARY_CUSTOM_PROGRESSBAR;
import static com.just.agentweb.sample.activity.AgentWebMainActivity.FLAG_GUIDE_DICTIONARY_CUSTOM_WEBVIEW_SETTINGS;
import static com.just.agentweb.sample.activity.AgentWebMainActivity.FLAG_GUIDE_DICTIONARY_CUTSTOM_WEBVIEW;
import static com.just.agentweb.sample.activity.AgentWebMainActivity.FLAG_GUIDE_DICTIONARY_FILE_DOWNLOAD;
import static com.just.agentweb.sample.activity.AgentWebMainActivity.FLAG_GUIDE_DICTIONARY_INPUT_TAG_PROBLEM;
import static com.just.agentweb.sample.activity.AgentWebMainActivity.FLAG_GUIDE_DICTIONARY_JSBRIDGE_SAMPLE;
import static com.just.agentweb.sample.activity.AgentWebMainActivity.FLAG_GUIDE_DICTIONARY_JS_JAVA_COMMUNICATION;
import static com.just.agentweb.sample.activity.AgentWebMainActivity.FLAG_GUIDE_DICTIONARY_JS_JAVA_COMUNICATION_UPLOAD_FILE;
import static com.just.agentweb.sample.activity.AgentWebMainActivity.FLAG_GUIDE_DICTIONARY_LINKS;
import static com.just.agentweb.sample.activity.AgentWebMainActivity.FLAG_GUIDE_DICTIONARY_MAP;
import static com.just.agentweb.sample.activity.AgentWebMainActivity.FLAG_GUIDE_DICTIONARY_PULL_DOWN_REFRESH;
import static com.just.agentweb.sample.activity.AgentWebMainActivity.FLAG_GUIDE_DICTIONARY_USE_IN_FRAGMENT;
import static com.just.agentweb.sample.activity.AgentWebMainActivity.FLAG_GUIDE_DICTIONARY_VASSONIC_SAMPLE;
import static com.just.agentweb.sample.activity.AgentWebMainActivity.FLAG_GUIDE_DICTIONARY_VIDEO_FULL_SCREEN;
import static com.just.agentweb.sample.activity.AgentWebMainActivity.FLAG_GUIDE_DICTIONARY_WEBRTC;

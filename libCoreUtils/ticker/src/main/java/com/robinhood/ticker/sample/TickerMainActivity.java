...
public class TickerMainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ticker_main);
        ...
        findViewById(R.id.perfBtn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(TickerMainActivity.this, PerfActivity.class));
            }
        });
        ...
        findViewById(R.id.slideBtn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(TickerMainActivity.this, SlideActivity.class));
            }
        });
    }

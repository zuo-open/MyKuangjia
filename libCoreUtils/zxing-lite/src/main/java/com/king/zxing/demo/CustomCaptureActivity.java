...
import com.king.zxing.demo.util.StatusBarUtils;
...
public class CustomCaptureActivity extends CaptureActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        tvTitle.setText(getIntent().getStringExtra(ZxingLiteMainActivity.KEY_TITLE));

        isContinuousScan = getIntent().getBooleanExtra(ZxingLiteMainActivity.KEY_IS_CONTINUOUS, false);
    ...
    public void initCameraScan() {
        ...
        decodeConfig.setHints(DecodeFormatManager.ALL_HINTS)////设置解码
                ...
                .setAreaRectRatio(1.0f)//设置识别区域比例，默认0.8，设置的比例最终会在预览区域裁剪基于此比例的一个矩形进行扫码识别

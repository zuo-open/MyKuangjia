 ...
 */
public class ZxingLiteMainActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zxing_lite_main);
...
//            }
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn0) {
            ...
            this.cls = CaptureWithSelectPhotoActivity.class;
            this.title = ((Button) v).getText().toString();
            checkCameraPermissions();
        }

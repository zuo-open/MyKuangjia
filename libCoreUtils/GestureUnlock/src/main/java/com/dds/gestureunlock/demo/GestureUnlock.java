...
public class GestureUnlock {
    ...
    public void createGestureUnlock(Context activityContext) {
        GestureUnlockActivity.openActivity(activityContext, GestureLockActivity.TYPE_GESTURE_CREATE);
    }

    public void verifyGestureUnlock(Context activityContext) {
        GestureUnlockActivity.openActivity(activityContext, GestureLockActivity.TYPE_GESTURE_VERIFY);
    }

    public void modifyGestureUnlock(Context activityContext) {
        GestureUnlockActivity.openActivity(activityContext, GestureLockActivity.TYPE_GESTURE_MODIFY);
    }
